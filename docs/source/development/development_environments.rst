...
========================
This guide will walk you through setting up a local development environment for contributing to `BATMODS-lite`. It covers recommended practices, tools, and commands for developers to efficiently build, test, and contribute to the project.
...
3. Install `BATMODS-lite` in editable mode
    Once you have your virtual environment activated and the files locally available, install `BATMODS-lite` in editable mode, including the necessary development tools and dependencies, like so::
...
Now that you're all setup with a development version of `BATMODS-lite` and have tested the codebase using the `nox` integration, be sure to follow the :doc:`version_control` workflow as you contribute. Happy coding!
