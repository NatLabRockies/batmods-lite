...
After tests finish running, you can check the coverage by opening the `index.html` file in the `reports/htmlcov/` folder. This will help you navigate through the source code files to see which lines are and are not covered.
