...
:py:mod:`bmlite.materials._graphite_fast`
=========================================

.. py:module:: bmlite.materials._graphite_fast
...
.. autoapisummary::
   ...
   bmlite.materials._graphite_fast.GraphiteFast




.. py:class:: GraphiteFast(alpha_a: float, alpha_c: float, Li_max: float)
