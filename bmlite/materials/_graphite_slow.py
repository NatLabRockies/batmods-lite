...
class GraphiteSlow(object):
    ...
    def get_Eeq(self, x: float | _ndarray, T: float) -> float | _ndarray:
        ...
        conditions.append((x >= 0.0) & (x < 0.0037))
        eval_funcs.append(
            lambda x: np.polyval(
                [
                    181010.33572359575,
        ...
        eval_funcs.append(
            lambda x: np.polyval(
                [
                    -10.010709971262454,
                    0.054477719206830554,
                    -5.7739517287122876e-05,
                    0.101712,
                ],
                x - 0.558,
            )
        ...
        eval_funcs.append(
            lambda x: np.polyval(
                [
                    3.004697261146363,
                    -0.017892663208344477,
                    2.349549665503608e-05,
                    0.101559,
                ],
                x - 0.599,
            )
        ...
        eval_funcs.append(
            lambda x: np.polyval(
                [
                    209.9104841952816,
                    0.004136750256258037,
                    -0.003375114748149544,
                    0.101254,
                ],
                x - 0.662,
            )
