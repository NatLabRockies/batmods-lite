...
class GraphiteFast(object):
    ...
    def get_Eeq(self, x: float | _ndarray, T: float) -> float | _ndarray:
        ...
        A = np.array(
            [
                -1.059423355572770e-2,
                -1.453708425609560e-2,
                9.089868397988610e-5,
                2.443615203087110e-2,
                -5.464261369950400e-1,
                6.270508166379020e-1,
                -1.637520788053810e-2,
                -5.639025014475490e-1,
                7.053886409518520e-2,
                -6.542365622896410e-2,
                -5.960370524233590e-1,
                1.409966536648620e0,
                -4.173226059293490e-2,
                -1.787670587868640e-1,
                7.693844911793470e-2,
                -4.792178163846890e-1,
                3.845707852011820e-3,
                4.112633446959460e-2,
        ...
        B = np.array(
            [
                -4.364293924074990e-2,
                -9.449231893318330e-2,
                -2.046776012570780e-2,
                -8.241166396760410e-2,
                -7.746685789572230e-2,
                3.593817905677970e-2,
            ]
        )
        ...
        E = np.array(
            [
                -4.364293924074990e-2,
                -9.449231893318330e-02,
                -2.046776012570780e-2,
                -8.241166396760410e-2,
                -7.746685789572230e-02,
                3.593817905677970e-2,
            ]
        )
